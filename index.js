...
*/
//using the function below to return an object...
function createMenuItem(name, price, category){
   return {name, price, category};
}

console.log('task 1a', createMenuItem('chai', 3, 'drink'));
...
console.log('task 1b', createMenuItem('swiss', 5, 'cheese'));
console.log('task 1b', createMenuItem('lasagna', 12, 'pasta'));
console.log('task 1b', createMenuItem('apple', 1, 'fruit'));
